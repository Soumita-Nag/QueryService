<template>
  <div class="w-full max-w-2xl mx-auto space-y-4 pt-20">
   <div class="cursor-pointer space-y-4 bg-white shadow-md rounded-xl p-4" v-for="p in props.answeredQueries.slice().reverse()" :key="p.queryId">
